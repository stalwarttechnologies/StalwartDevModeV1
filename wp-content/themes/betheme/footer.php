					...
					<div class="copyright">
						<?php 
							if( mfn_opts_get('footer-copy') ){
								...
								echo '&copy; '. date( 'Y' ) .' '. get_bloginfo( 'name' ) .'. All Rights Reserved. Designed & Developed by <a target="_blank" rel="nofollow" href="http://stalwart-technologies.com">STALWART TECHNOLOGIES</a>';
							}
						?>
					</div>
